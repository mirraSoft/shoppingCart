...
<select name="menu" onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="Choose">
		<option value = ''> Choose </option>
         <option value="list_all_products.php">None</option>
          <option value="list_all_products.php?filterby=Footwear&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">Footwear</option>
          <option value="list_all_products.php?filterby=Clothing&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">Clothing</option>
          <option value="list_all_products.php?filterby=Watches&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">Watches</option>
          <option value="list_all_products.php?filterby=HandBag&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">HandBag</option>
          <option value="list_all_products.php?filterby=Perfumes&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">Perfumes</option>
          <option value="list_all_products.php?filterby=Jewellery&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">Jewellery</option>
          <option value="list_all_products.php?filterby=Sunglasses&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">Sunglasses</option>
          <option value="list_all_products.php?filterby=EBooks&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
		...
		if(isset($_GET['way']))
			...
			echo "DESC";
		?>">EBooks</option>
          <option value="list_all_products.php?filterby=DVD&sortby=<?php 
		if(isset($_GET['sortby']))
			echo $sortby; 
		else
			echo "date_added";
